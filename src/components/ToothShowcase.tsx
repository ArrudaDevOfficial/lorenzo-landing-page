...
export function ToothShowcase() {
  return (
    <section id="tecnologia" aria-label="Tecnologia e precisão">
      <div className="relative h-[80vh] min-h-[440px] overflow-hidden bg-[var(--preto)] sm:h-[88vh]">
        <img
        ...
        <div
          ...
          style={{
            background:
              'linear-gradient(180deg, rgba(19,26,30,0.78) 0%, rgba(19,26,30,0.42) 32%, rgba(19,26,30,0.42) 68%, rgba(19,26,30,0.85) 100%)',
          }}
        />

        <div className="relative mx-auto flex h-full max-w-4xl flex-col items-center justify-center px-6 text-center sm:px-8">
          <Reveal>
            <p className="font-serif text-xs font-medium tracking-[0.28em] text-white/70 uppercase">
              Tecnologia a serviço do sorriso
            </p>
            <h2 className="text-balance mt-3 font-serif text-3xl font-medium tracking-tight text-white sm:text-4xl md:text-5xl">
